...
parm='sys.psf'  # GROMACS: tpr file, AMBER: prmtop file
trj='sys.dcd'  # .xtc, .trr, .nc etc
refFrame='sys.pdb'
outfile='persistence.dat'
...
start = time.time()
#Define residue id (terminal 5 residues from the each end are excluded)
