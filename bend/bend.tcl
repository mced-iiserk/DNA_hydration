set out1 [open "sys_bend.dat" w]
mol new sys.psf
#set reference frame
set ref [mol addfile sys.pdb]
set nf [molinfo top get numframes]
#Mention number of residues
for {set res 1} {$res < 100} {incr res} {
set theta_l ""
#Mention number of frames
for {set f 1} {$f < 50} {incr f} {
	mol new sys.psf
        mol addfile sys.dcd first $f last $f
	...
	puts "sys_vec  $sys_vec"
	puts "ref_vec $ref_vec"	
	...
	mol delete top
	unset rBx rBy rBz rAx rAy rAz r2Bz r2By r2Bx r1Bz r1By r1Bx r2Az r2Ay r2Ax r1Az r1Ay r1Ax rBfz rBfy rBfx r2Bfz r2Bfy r2Bfx rAz rAy rAx r1Bfz r1Bfy r1Bfx
	}
